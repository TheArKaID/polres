...
<body>
  ...
  <div class="container mt-5 pt-5 mb-5">
    <div class="row center-kop">
      <img class="mr-4" style="width: 100%" src="{{asset('frontend/img/setting/'.settings()->logo)}}" alt="">
    </div>
  </div>
  ...
  <div class="container mt-4 mb-5" style="text-align: center">
    <a class="navbar-brand btn btn-light" style="" href="/"><i class="fas fa-arrow-left" style="font-size: 16px"></i>
      Kembali</a>
  </div>
